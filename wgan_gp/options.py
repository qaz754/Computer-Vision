...
class options():
    ...
    def initialize(self):
        ...
        #WGAN options
        self.parser.add_argument('--gp_lambda', type=int, nargs='?', default=10, help='WGAN Gradient Penalty value')
        self.parser.add_argument('--n_critic', type=int, nargs='?', default=5, help='number of critics updates before G updates')
