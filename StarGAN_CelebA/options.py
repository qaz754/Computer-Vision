...
class options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--num_classes', type=int, nargs='?', default=40, help='number of classes')
        ...
        #Training Options
        self.parser.add_argument('--model_name', type=str, nargs='?', default='stargan', help='name of the model to be saved')
        ...
        self.parser.add_argument('--save_every', type=int, nargs='?', default=200000, help='how often to save the model')
        ...
        self.parser.add_argument('--const_epoch', type=int, nargs='?', default=10, help='number of epochs where LR is constant')
        self.parser.add_argument('--adaptive_epoch', type=int, nargs='?', default=10, help='number of epochs where LR changes')
