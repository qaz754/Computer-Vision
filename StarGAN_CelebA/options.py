...
class options():
    ...
    def initialize(self):
        ...
        # Training Options
        self.parser.add_argument('--epoch', type=int, nargs='?', default=25, help='total number of training episodes')
        self.parser.add_argument('--const_epoch', type=int, nargs='?', default=8, help='number of epochs where LR is constant')
        self.parser.add_argument('--adaptive_epoch', type=int, nargs='?', default=17, help='number of epochs where LR changes')
        self.parser.add_argument('--show_every', type=int, nargs='?', default=2500, help='How often to show images')
        self.parser.add_argument('--print_every', type=int, nargs='?', default=500, help='How often to print scores')
        self.parser.add_argument('--save_every', type=int, nargs='?', default=50000, help='How often to show images')
        ...
        self.parser.add_argument('--num_classes', type=int, nargs='?', default=1, help='number of classes')
        ...
        self.parser.add_argument('--n_discrim_down', type=int, nargs='?', default=5, help='hidden layer configuration in a list form for D')
