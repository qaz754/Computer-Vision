...
class options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--show_every', type=int, nargs='?', default=50, help='How often to show images')
        self.parser.add_argument('--print_every', type=int, nargs='?', default=50, help='How often to print scores')
        ...
        self.parser.add_argument('--n_resblock', type=int, nargs='?', default=9, help='number of resnet')
